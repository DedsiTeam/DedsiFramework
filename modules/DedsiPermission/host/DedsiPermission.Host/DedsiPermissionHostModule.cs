...
[DependsOn(
    typeof(DedsiPermissionHttpApiModule),

    typeof(AbpEntityFrameworkCoreSqlServerModule),
    typeof(AbpAutofacModule)
)]
public class DedsiPermissionHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.ApplicationName = DedsiPermissionDomainConsts.ApplicationName;
