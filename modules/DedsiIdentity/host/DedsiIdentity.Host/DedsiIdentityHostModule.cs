...
[DependsOn(
    typeof(DedsiIdentityHttpApiModule),

    typeof(AbpEntityFrameworkCoreSqlServerModule),
    typeof(AbpAutofacModule)
)]
public class DedsiIdentityHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.ApplicationName = DedsiIdentityDomainConsts.ApplicationName;
